...
const index = () => {
  ...
  return (
    <>
      <div className="relative bg-tv-mount-bg bg-cover bg-center h-[635px]">
          ...
          <div className="flex flex-col justify-between w-full gap-4 py-8 lg:flex-row">
            ...
            <div className="flex justify-between gap-3">
              <div className="w-[124px] h-[124px] border rounded-md flex flex-col gap-5 justify-center items-center">
                <img src="/images/services/31-inch.svg" alt="" />
                <span className="text-sm">Up to 31"</span>
              </div>
              <div className="w-[124px] h-[124px] border rounded-md flex flex-col gap-5 justify-center items-center">
                <img src="/images/services/60-inch.svg" alt="" />
                <span className="text-sm">32" - 60"</span>
              </div>
              <div className="w-[124px] h-[124px] border rounded-md flex flex-col gap-5 justify-center items-center">
                <img src="/images/services/80-inch.svg" alt="" />
                <span className="text-sm">61" - 80"</span>
              </div>
              <div className="w-[124px] h-[124px] border rounded-md flex flex-col gap-5 justify-center items-center">
                <img src="/images/services/over_81.svg" alt="" />
                <span className="text-sm">Over 81"</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto my-3 max-w-container xl:max-w-container-xl 2xl:max-w-container-2xl">
        <div className="flex w-full h-[398px]">
          <div className="w-[385px] px-12 h-full flex justify-center items-start flex-col border rounded-md gap-4">
            ...
            <button className="px-6 py-3 font-semibold text-white bg-primary-color">
              Fix my Application
            </button>
          </div>
          <div>
